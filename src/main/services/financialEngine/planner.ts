...
- «جریان نقد» یا «جریان وجوه نقد» (بدون کلمهٔ «صورت») → cashflow (مانده نقد و بانک)
- «صورت جریان نقد» یا «صورت جریان وجوه نقد» (با کلمهٔ «صورت») → cash_flow_statement (نه cashflow)
...
Answer: {"metricId":"cashflow","grain":"total","filters":[],"confidence":0.9}
...
Example 37 (S41 party_count):
Question: تعداد طرف حساب‌ها
Answer: {"metricId":"party_count","grain":"total","filters":[],"confidence":0.9}

Example 38 (S41 voucher_count):
Question: تعداد سندهای حسابداری ۱۴۰۲
Answer: {"metricId":"voucher_count","grain":"by_year","filters":[{"dimension":"by_year","op":"eq","values":["1402"]}],"confidence":0.9}
