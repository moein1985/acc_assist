...
const catalog: MetricDefinition[] = [
  ...
  },
  {
    ...
    anchors: ['سند ترازنشده', 'سندهای تراز ندارند', 'اختلاف سند', 'سند با اختلاف', 'کدام سندها تراز نیستند', 'سندهای ناتراز', 'تراز نشده', 'تراز ندارن', 'ترازنشده', 'تراز ندارند', 'نامتوازن', 'اسناد نامتوازن', 'سند نامتوازن', 'سندهای نامتوازن'],
